...
namespace NumeralSystems
{
    public static class Converter
    {
        ...
        public static string GetPositiveOctal(this int number) =>
            (number < 0) ? throw new ArgumentException($"{number}") : Convert.ToString(number, 8); 
        ...
        public static string GetPositiveDecimal(this int number) => 
            (number < 0) ? throw new ArgumentException($"{number}") : Convert.ToString(number, 10); 
        ...
        public static string GetPositiveHex(this int number) => 
            (number < 0) ? throw new ArgumentException($"{number}") : Convert.ToString(number, 16).ToUpper();
        ...
        public static string GetPositiveRadix(this int number, int radix) => 
            (number < 0 || (radix != 8 && radix != 10 && radix != 16)) ? throw new ArgumentException($"{number}") : Convert.ToString(number, radix).ToUpper();
        ...
        public static string GetRadix(this int number, int radix) => 
            (radix != 8 && radix != 10 && radix != 16) ? throw new ArgumentException($"{radix}") : Convert.ToString(number, radix).ToUpper();
    }
}
